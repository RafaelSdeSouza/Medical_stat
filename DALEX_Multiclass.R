...
# AGE
ale_rf1_age   <- variable_response(explain_rf_1, variable =  "AGE", type = "pdp")
ale_rf2_age   <- variable_response(explain_rf_2, variable =  "AGE", type = "pdp")
ale_rf3_age   <- variable_response(explain_rf_3, variable =  "AGE", type = "pdp")
ale_rf4_age   <- variable_response(explain_rf_4, variable =  "AGE", type = "pdp")
